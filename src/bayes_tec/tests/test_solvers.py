...
#    num_threads = 1
    ...
    solver.solve(solset='sol000', recalculate_coords=False, jitter=1e-6, tec_scale=0.005, screen_res=30, weight_smooth_len=40, reweight_obs=False, 
            learning_rate=1e-2,iterations=2000, minibatch_size=128, dof_ratio=20.,intra_op_threads=64, inter_op_threads=32, ant_sel="RS*",
            time_sel=slice(0,100,1),pol_sel=slice(0,1,1),debug=False)#,load_model='/home/albert/git/bayes_tec/src/bayes_tec/tests/run_dir_killms_new/run_021/checkpoints/save_000/model.hdf5')
