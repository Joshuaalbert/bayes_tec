...
def run_solve(flags):
    solver = OverlapPhaseOnlySolver(flags.overlap, flags.run_dir, flags.datapack)
...
def add_args(parser):
    ...
    optional.add_argument("--shared_kernels", type="bool", default=True,
                       help="""Whether to share kernel between GPs.""")
    optional.add_argument("--shared_features", type="bool", default=True,
                       help="""Whether to share features between GPs.""")
